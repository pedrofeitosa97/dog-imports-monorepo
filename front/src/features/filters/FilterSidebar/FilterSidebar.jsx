...
import { GENDERS, SIZES } from '../../../utils/constants'
import { SORT_OPTIONS } from '../../../utils/constants'
import Select from '../../../ui/Select/Select'

export default function FilterSidebar({ filters, setFilter, toggleFilter, clearFilters, totalCount = 0, brands = [], categories = [], colors = [] }) {
  return (
    <SidebarWrapper>
      <SidebarHeader>
        <Title>Filtros</Title>

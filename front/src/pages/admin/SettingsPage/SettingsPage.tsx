  ...
  return (
    <Page>
      <LogoField
        ...
        hint="Recomendado: 200×200px ou maior, quadrado, PNG com fundo transparente. Exibido a 200×200px no header e 42×42px na sidebar do admin."
        previewW={200}
        previewH={200}
        previewLabel="200 × 200px"
